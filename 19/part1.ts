...
function solve(bp: number[], mins: number) {
  const [bp_id, ore_bot_cost, clay_bot_cost, obs_bot_ore_cost, obs_bot_clay_cost, geode_bot_ore_cost, geode_bot_obs_cost] = bp;
...
console.log('total', bps.reduce((p, bp) => p + solve(bp, 24), 0));
